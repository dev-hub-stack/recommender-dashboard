  ...
  const metricsData = [
    {
      ...
      label: "Total Collaborative Recommendations",
      value: formatLargeNumber(metrics?.totalRecommendations || 0),
      percentage: "Live",
    ...
    },
    {
      ...
      value: formatPercentage(metrics?.avgSimilarityScore || 0, 1),
      percentage: "Live",
    ...
    },
    {
      ...
      label: "Active Customer Pairs",
      value: formatLargeNumber(metrics?.activeCustomerPairs || 0),
      percentage: "Live",
    ...
    },
    {
      ...
      value: formatPercentage(metrics?.algorithmAccuracy || 0, 1),
      percentage: "Live",
