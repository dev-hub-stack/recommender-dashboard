    ...
    const sampleMetrics = [
      {
        ...
        tooltip: "Total number of product recommendations generated by our ML algorithm (Sample Data)",
        value: "2.4M",
        percentage: "Sample",
      ...
      },
      {
        ...
        tooltip: "How well we can match customers with similar buying patterns (Sample Data)",
        value: "87.3%",
        percentage: "Sample",
      ...
      },
      {
        ...
        label: "Similar Customer Groups",
        tooltip: "Customers grouped together based on their purchase history (Sample Data)",
        value: "18,547",
        percentage: "Sample",
      ...
      },
      {
        ...
        tooltip: "How often customers actually buy the products we recommend (Sample Data)",
        value: "92.1%",
        percentage: "Sample",
  ...
  const metricsData = [
    {
      icon: "/vuesax-linear-lamp-charge.svg",
      label: "Products Recommended",
      tooltip: "Total number of product recommendations generated by our ML algorithm",
    ...
    },
    {
      icon: "/vuesax-linear-user-search.svg",
      label: "Customer Match Rate",
      tooltip: "How well we can match customers with similar buying patterns (higher = better recommendations)",
    ...
    },
    {
      icon: "/vuesax-linear-user-edit.svg",
      label: "Similar Customer Groups",
      tooltip: "Customers grouped together based on their purchase history for personalized recommendations",
    ...
    },
    {
      icon: "/vuesax-linear-chart-2.svg",
      label: "Prediction Accuracy",
      tooltip: "How often customers actually buy the products we recommend",
